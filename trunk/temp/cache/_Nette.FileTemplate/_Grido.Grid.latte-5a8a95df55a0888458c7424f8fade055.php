<?php //netteCache[01]000442a:2:{s:4:"time";s:21:"0.26100500 1387398004";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:121:"C:\Program Files (x86)\EasyPHP-DevServer-13.1VC11\data\localweb\projects\zverejnovanienew\app\components\Grido\Grid.latte";i:2;i:1385542268;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:28:"$WCREV$ released on $WCDATE$";}}}?><?php

// source file: C:\Program Files (x86)\EasyPHP-DevServer-13.1VC11\data\localweb\projects\zverejnovanienew\app\components\Grido\Grid.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'l4nmovh0yi')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block _grid
//
if (!function_exists($_l->blocks['_grid'][] = '_lbbaf59552e0__grid')) { function _lbbaf59552e0__grid($_l, $_args) { extract($_args); $_control->validateControl('grid')
...
// block outerFilter
//
if (!function_exists($_l->blocks['outerFilter'][] = '_lb3f4e527a7d_outerFilter')) { function _lb3f4e527a7d_outerFilter($_l, $_args) { extract($_args)
...
// block table
//
if (!function_exists($_l->blocks['table'][] = '_lb7ed7d7a89b_table')) { function _lb7ed7d7a89b_table($_l, $_args) { extract($_args)
...
<?php if (is_string($column->getCustomRender())): Nette\Latte\Macros\CoreMacros::includeTemplate($column->getCustomRender(), array('control' => $control, 'presenter' => $control->getPresenter(), 'item' => $row) + $template->getParameters(), $_l->templates['l4nmovh0yi'])->render() ;else: ?>
...
// block operations
//
if (!function_exists($_l->blocks['operations'][] = '_lbaf3a024195_operations')) { function _lbaf3a024195_operations($_l, $_args) { extract($_args)
...
// block paginator
//
if (!function_exists($_l->blocks['paginator'][] = '_lbd40258af40_paginator')) { function _lbd40258af40_paginator($_l, $_args) { extract($_args)
...
// block count
//
if (!function_exists($_l->blocks['count'][] = '_lbbb7f4bb1c6_count')) { function _lbbb7f4bb1c6_count($_l, $_args) { extract($_args)
?>                <span class="count">
